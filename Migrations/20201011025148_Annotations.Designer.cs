...
namespace RazorPages.Migrations
{
    ...
    [Migration("20201011025148_Annotations")]
            ...
            modelBuilder.Entity("RazorPages.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2020, 10, 10, 22, 51, 47, 784, DateTimeKind.Local).AddTicks(2099),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2020, 10, 10, 22, 51, 47, 787, DateTimeKind.Local).AddTicks(8482),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2020, 10, 10, 22, 51, 47, 787, DateTimeKind.Local).AddTicks(8541),
                            ServicesID = 5
                        });
                });
